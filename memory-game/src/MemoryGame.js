...
export default class MemoryGame extends Component {
   constructor(props) {
      ...
      let cards = [
         ...
         { id: 8, cardState: CardState.HIDING, backgroundColor: 'purple' },
         ...
         { id: 12, cardState: CardState.HIDING, backgroundColor: 'lightskyblue' },
         { id: 13, cardState: CardState.HIDING, backgroundColor: 'lightskyblue' }
      ];
